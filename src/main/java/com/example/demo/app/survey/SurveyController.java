...
public class SurveyController {
	...
	public String index(Model model) {
		...
		model.addAttribute("title", "SurveyIndex");
	...
	public String complete(@Validated SurveyForm surveyForm, BindingResult result, Model model,
		...
		survey.setAge(survey.getAge());
		survey.setSatisfaction(survey.getSatisfaction());
		survey.setComment(survey.getComment());
		survey.setCreated(survey.getCreated());
		
		// データベースに登録される
		surveyService.save(survey);
		redirectAttributes.addFlashAttribute("complete", "Survey Send!");
